   ...
   <div class="row p-0 ">
      ...
      <div class="col bg-white " style="">
         <ul class="nav nav-tabs justify-content-center  p-0 " id="myTab" role="tablist">
            <li class="nav-item">
               <a class="nav-link active " id="home-tab" data-toggle="tab" href="#friends1" role="tab" aria-controls="home" aria-selected="true">Friends</a>
            </li>
            <li class="nav-item">
         ...
         <div class="tab-content bg-white mt-2 "  style="overflow-y:hidden;overflow-x:hidden;height:93vh;bottom:0;border:none">
            ...
            <div class="tab-pane fade bg-white contentmain1"  id="mentor" role="tabpanel" aria-labelledby="mentor" style="overflow-y:scroll;overflow-x:hidden;height:93vh;transition: all 0.3s ease-in;
               ">
             <!--   <div class="d-flex  justify-content-start " style="width:10rem;position:fixed;top:4.1rem;left:32.5rem;border:none;z-index:999">
               ...
               <div class="row   " style="height:;width:rem;border:none">
                           ...
                           <div class="carousel-inner ">
                              ...
                              <div class="carousel-item mt-1 <?php if ($feedcounter == 1){echo 'active';}?> ">
                                 <div class="card" style="border:none">
                                    ...
                                    <?php if(in_array ( $feeddata['content_type'], $image_formats)){?>
                                     <img class="card-img-top mr-2  " style="height:9rem"src="<?php echo str_replace("index.php/","",base_url()).'uploads/'.$feeddata['content_link'];?>" style="width:rem;height:rem;object-fit:;"  alt="Card image cap" >
                                       <?php }else if(in_array ( $feeddata['content_type'], $audio_formats)){?>
                                                                <audio controls>
                              <source src="<?php echo str_replace("index.php/","",base_url()).'uploads/'.$feeddata['content_link'];?>" type="'.$row->content_type.'">
                                      Your browser does not support the audio element.
                                  </audio>
                                       <?php }else if(in_array ( $feeddata['content_type'], $document_formats)){ ?>
                                          <a href="https://drive.google.com/viewer?url='<?php echo str_replace("index.php/","",base_url()).'uploads/'.$feeddata['content_link'];?>'">'.$row->content_link.'</a>
                                       <?php }else if(in_array ( $feeddata['content_type'], $video_formats)){ ?>
                                          <video width="400" height="240" controls>
                   <source src="<?php echo str_replace("index.php/","",base_url()).'uploads/'.$feeddata['content_link'];?>" >
                ...
                Your browser does not support the video tag.
                  ...
                  <?php  if($cnter ==  3 || $counter == count($mentordata) ){?> 
